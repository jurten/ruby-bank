...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference("Turn.count") do
      post turns_url, params: { turn: { branch_id: @turn.branch_id, comment: @turn.comment, date: @turn.date, reason: @turn.reason, staff_id: @turn.staff_id, status: @turn.status, user_id: @turn.user_id } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { branch_id: @turn.branch_id, comment: @turn.comment, date: @turn.date, reason: @turn.reason, staff_id: @turn.staff_id, status: @turn.status, user_id: @turn.user_id } }
